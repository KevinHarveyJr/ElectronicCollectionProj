...
namespace Electronic_Collection.Controllers
{
    public class CollectorWishlistsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("WishListId,WishList,CollectorId,ItemId,RAWGItemTitle")] CollectorWishlist collectorWishlist)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("WishListId,WishList,CollectorId,ItemId,RAWGItemTitle")] CollectorWishlist collectorWishlist)
        {
